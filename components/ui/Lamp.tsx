    ...
    <LampContainer>
      <div className="flex flex-col gap-24 items-center">
        ...
        >
          ...
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-8 py-3 text-xl font-medium text-white backdrop-blur-3xl">
            Sign Up
          </span>
        </Link>
      </div>
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-40 h-24 w-full -translate-y-[12.5rem] bg-black"></div>
      </div>
